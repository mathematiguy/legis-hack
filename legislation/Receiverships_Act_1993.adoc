...
b Secondly, to pay preferential claims to the extent and in the order of priority specified in Schedule 7 (except clauses 1 and 9(b) ) to the Companies Act 1993before paying from those assets any claim of the person entitled to the security interest.
